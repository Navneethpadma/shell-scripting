...
setup_service() {
  ...
  sed -i  -e 's/MONGO_DNSNAME/mongodb.thenavops.com/' -e 's/MONGO_ENDPOINT/mongodb.thenavops.com/' -e 's/REDIS_ENDPOINT/redis.thenavops.com/' -e 's/CATALOGUE-ENDPOINT/catalogue.thenavops.com/' /etc/systemd/system/${COMPONENT}.service
